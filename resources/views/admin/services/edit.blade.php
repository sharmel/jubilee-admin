...
{!! Form::model($service,['method'=>'PATCH', 'action'=>['ServiceController@update', $service->id],'files'=>true]) !!}
...
<div class="col-md-6">
	    <div class="form-group">
	  	...
	  	{!! Form::label('image' , 'Image Source') !!} 
		    {!! Form::file('image_src[]', null,['class'=>'form-control','id'=>'image','multiple'=>'multiple']) !!}
	  </div>
