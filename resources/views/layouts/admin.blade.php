...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin: 0;">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ url('/') }}">Jubilee Admin</a>
        </div>
        <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i> Vendor<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{route('vendors.show',$vendor_id)}}">View my details</a>
                                </li>
                               
                                <li>
                                    <a href="{{route('vendors.edit',$vendor_id)}}">Edit my details</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
